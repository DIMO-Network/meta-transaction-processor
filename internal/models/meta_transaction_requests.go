...
type MetaTransactionRequest struct {
	...
	SubmittedBlockNumber types.Decimal     `boil:"submitted_block_number" json:"submitted_block_number" toml:"submitted_block_number" yaml:"submitted_block_number"`
	SubmittedBlockHash   []byte            `boil:"submitted_block_hash" json:"submitted_block_hash" toml:"submitted_block_hash" yaml:"submitted_block_hash"`
...
var MetaTransactionRequestWhere = struct {
	...
	SubmittedBlockNumber whereHelpertypes_Decimal
	SubmittedBlockHash   whereHelper__byte
	...
	SubmittedBlockNumber: whereHelpertypes_Decimal{field: "\"meta_transaction_processor\".\"meta_transaction_requests\".\"submitted_block_number\""},
	SubmittedBlockHash:   whereHelper__byte{field: "\"meta_transaction_processor\".\"meta_transaction_requests\".\"submitted_block_hash\""},
...
func (o *MetaTransactionRequest) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"meta_transaction_processor\".\"meta_transaction_requests\"", updateOnConflict, ret, update, conflict, insert)
